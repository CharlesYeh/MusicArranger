...
public class Analyzer{
	...
	private void initMajorKeyGraph() {
		...
		// create chords
		ChordSymbol chordI	= new ChordSymbol(1, ChordType.MAJOR);
		ChordSymbol chordii	= new ChordSymbol(2, ChordType.MINOR);
		ChordSymbol chordiii	= new ChordSymbol(3, ChordType.MINOR);
		ChordSymbol chordIV	= new ChordSymbol(4, ChordType.MAJOR);
		ChordSymbol chordV	= new ChordSymbol(5, ChordType.MAJOR);
		ChordSymbol chordvi	= new ChordSymbol(6, ChordType.MINOR);
		ChordSymbol chordviio	= new ChordSymbol(7, ChordType.DIMIN);

		// V seven chords
		ChordSymbol chordV7	= new ChordSymbol(5, ChordType.MAJOR7, 0);
		ChordSymbol chordV65	= new ChordSymbol(5, ChordType.MAJOR7, 1);
		ChordSymbol chordV43	= new ChordSymbol(5, ChordType.MAJOR7, 2);
		ChordSymbol chordV42	= new ChordSymbol(5, ChordType.MAJOR7, 3);
